...
public:
    Logger(const String & app = "PicoSyslog", const String & host = "",
           const LogLevel default_loglevel = LogLevel::information,
           Print * forward_to = &Serial, const String & server = "",
           uint16_t port = 514);
...
public:
    SimpleLogger(const String & app = "PicoSyslog", const String & host = "",
